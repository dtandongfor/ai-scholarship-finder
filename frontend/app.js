...
const exampleProfiles = {
  ...
  transfer: { name: "Jordan Demo", major: "Information Systems", gpa: "3.4", year: "College sophomore", university: "Community College", state: "TX", citizenship: "US", interests: "cybersecurity, tutoring", student_type: "transfer", completed_credits: "62", enrollment_status: "full_time", skills: "networking, SQL", volunteer: "peer technology tutor" },
  tech: { name: "Riley Demo", major: "Cybersecurity", gpa: "3.5", year: "College junior", university: "North Carolina State University", state: "NC", citizenship: "US", interests: "cyber defense, public service", student_type: "current", completed_credits: "72", enrollment_status: "full_time", accepts_service_commitment: "true", can_seek_security_clearance: "true", skills: "Python, Linux, network security", certifications: "CompTIA Security+" },
};
